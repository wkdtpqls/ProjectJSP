...
<%
	...
	String sword = request.getParameter("sword");
	   if (sword==null || sword.equals("")) {
	      ...
	      count = pdao.getArticleCount("%"+sword+"%");   
	      if(count > 0) {
	         alist = pdao.getArticles(startRow, pageSize, "%"+sword+"%");
	      }else{
%>
		<script>
			alert("검색결과가 없습니다!");
...
<div class="con">
	<div class="text">
		...
		<div class="txt_box">
		    <ul class="menu">
		        <li class="menu-item"><a href="productlist.jsp" class="menu-link" style="background-color:#000040; color:white;">All</a></li>
...
<form name="search_form" method="get" action="productlist.jsp">
